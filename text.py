...
import random
from operator import main, interact, trace
...
class QueenAnt(ScubaThrower):  # You should change this line
    ...
    def action(self, gamestate):
        ...
        while not isinstance(place, AntHomeBase):
            ...
            if place.ant and place.ant.is_container() and place.ant.contained_ant and not hasattr(
                    place.ant.contained_ant, 'inspired'):
